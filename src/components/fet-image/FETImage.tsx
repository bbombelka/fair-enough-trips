...
import { FETImageProps } from "./FETImage.types";

export const FETImage: FC<FETImageProps> = ({ onLoad, blurDataURL, sizes = "100vw", className, ...props }) => {
  ...
  return (
    <>
      ...
      <NextImage
        ...
        onLoad={onImageLoad}
        blurDataURL={blurDataURL ? `data:image/webp;base64,${blurDataURL}` : undefined}
        sizes={sizes}
